...
urlpatterns = patterns('',
   	...
   	url(r'^update_simulations/(?P<sim_id>\d+)$', views.update_simulations, name='update_simulations'),
   	url(r'^view_analysis/(?P<sim_id>\d+)$', views.view_analysis, name='view_analysis'),
